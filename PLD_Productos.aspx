<%@ Page Title="" Language="C#" MasterPageFile="~/AdmOrdenes.master" AutoEventWireup="true" CodeFile="PLD_Productos.aspx.cs" Inherits="PLD_Productos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <telerik:RadWindow RenderMode="Lightweight" ID="modalNuevo" Title="Nuevo Producto" EnableShadow="true" Skin="Metro"
                ...
                <ContentTemplate>
                     <asp:Panel ID="Panel2" runat="server" CssClass="ancho100 text-center">
                        <div class="col-lg-12 col-sm-12 text-center">
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label6" runat="server"  Text="ID Producto:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtIDProductoAdd"  runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>

                        <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label5" runat="server" visible="false" Text="Código Producto:" CssClass="textoBold"></asp:Label></div>
                        ...
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtEscalaAdd" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label8" runat="server" Text="Nombre Producto:" CssClass="textoBold"></asp:Label></div>
     ...
     <%-- Modifica Producto --%>
    <telerik:RadWindow RenderMode="Lightweight" ID="modalModifica" Title="Editar Producto" EnableShadow="true" Skin="Metro"
                ...
                <ContentTemplate>
                     <asp:Panel ID="Panel1" runat="server" CssClass="ancho100 text-center">
                        <div class="col-lg-12 col-sm-12 text-center">
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label2" runat="server" Text="Código de Producto:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtCodProductoEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label7" runat="server" Text="ID Producto:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtIDProductoEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
                        ...
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtEscalaEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label3" runat="server" Text="Nombre Producto: " CssClass="textoBold"></asp:Label></div>
     ...
     <div class="row">
        <div class="col-lg-12 col-sm-12 text-center alert-info">
            <h3>
                ...
                <asp:Label ID="Label10" runat="server" Text="Catálogo de Productos"></asp:Label>
            </h3>
        </div>
    </div>
            ...
            <asp:Panel ID="pnlContenido" CssClass="col-lg-12 col-sm-12" runat="server" ScrollBars="Auto">
                <asp:Panel ID="pnlCatalogos" runat="server" CssClass="col-lg-12 col-sm-12" ScrollBars="Auto">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" AllowFilteringByColumn="true" OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged" runat="server" EnableHeaderContextMenu="true" Culture="es-Mx" Skin="Metro" 
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="false" DataKeyNames="codigo_producto">
                            <Columns>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="codigo_producto" FilterControlAltText="Filtro codigo_producto" HeaderText="Codigo de Producto" SortExpression="codigo_producto" UniqueName="codigo_producto" Resizable="true" />
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="tpro_id" FilterControlAltText="Filtro tpro_id" HeaderText="Id de Producto" SortExpression="tpro_id" UniqueName="tpro_id" Resizable="true"  />
                                ...
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="nombre_producto" FilterControlAltText="Filtro nombre_producto" HeaderText="Producto" SortExpression="nombre_producto" UniqueName="nombre_producto" Resizable="true" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select codigo_producto, id_escala, nombre_producto, tpro_id from PLD_Producto order by cast (codigo_producto as int)" ConnectionString="<%$ ConnectionStrings:Taller %>">
                </asp:SqlDataSource>
                </asp:Panel>
            </asp:Panel>
