<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BitComentariosOrden.aspx.cs" Inherits="BitComentariosOrden" MasterPageFile="~/AdmonOrden.master" Culture="es-Mx" UICulture="es-Mx"%>
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 text-center alert-info">
                    <h3>
                        ...
                        <asp:Label ID="Label1" runat="server" Text="Bitácora de Comentarios"></asp:Label>                        
                    </h3>                    
                </div>
            </div>
            <div class="row">
            ...
            <asp:Panel runat="server" ID="pnlCronos" CssClass="paneles col-lg-12 col-sm-12" ScrollBars="Auto">
                <div class="row">
                    <div class="col-lg-12 col-sm-12 text-center">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:LinkButton ID="lnkGuarda" runat="server" ToolTip="Guarda Comentario" CssClass="btn btn-success t14" onclick="lnkGuarda_Click" ><i class="fa fa-save"></i><span>&nbsp;Guarda Comentario</span></asp:LinkButton>
                    </div>
                </div>
                <br /><br />
                <div class="row">
