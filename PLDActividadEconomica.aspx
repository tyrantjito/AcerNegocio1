<%@ Page Title="" Language="C#" MasterPageFile="~/AdmOrdenes.master" AutoEventWireup="true" CodeFile="PLDActividadEconomica.aspx.cs" Inherits="PLDActividadEconomica" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <telerik:RadFormDecorator ID="RadFormDecorator1" RenderMode="Lightweight" runat="server" DecoratedControls="Buttons" />
     ...
     <%-- Nueva Actividad Economica --%>
    <telerik:RadWindow RenderMode="Lightweight" ID="modalNuevo" Title="Nueva Actividad Economica" EnableShadow="true" Skin="Metro"
            ...
            <asp:UpdatePanel ID="UpdatePanelEmi" runat="server">
                <ContentTemplate>
                     <asp:Panel ID="Panel2" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label5" runat="server" visible="false" Text="Código Actividad Economica:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtCodEconomicodAdd" Visible="false" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
                        ...
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtIdEscalaAdd" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label8" runat="server" Text="Actividad Economica:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtNomEconomicoAdd" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
     ...
     <%-- Modifica Actividad Economica --%>
    <telerik:RadWindow RenderMode="Lightweight" ID="modalModifica" Title="Editar Actividad Economica" EnableShadow="true" Skin="Metro"
            ...
            <asp:UpdatePanel ID="UpdatePanelEmiMod" runat="server">
                <ContentTemplate>
                     <asp:Panel ID="Panel1" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label2" runat="server" Text="Código de Actividad Economica:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtCodEconomicoEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
                        ...
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtEscalaEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label3" runat="server" Text="Actividad Economica: " CssClass="textoBold"></asp:Label></div>
                         <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtNomEconomicodEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
     ...
     <div class="row">
        <div class="col-lg-12 col-sm-12 text-center alert-info">
            <h3>
                ...
                <asp:Label ID="Label10" runat="server" Text="Catálogo de Actividad Economica"></asp:Label>
            </h3>
        </div>
    </div>
            ...
            <asp:Panel ID="pnlContenido" CssClass="col-lg-12 col-sm-12" runat="server" ScrollBars="Auto">
                <asp:Panel ID="pnlCatalogos" runat="server" CssClass="col-lg-12 col-sm-12" ScrollBars="Auto">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" AllowFilteringByColumn="true" OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged" runat="server" EnableHeaderContextMenu="true" Culture="es-Mx" Skin="Metro" 
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="false" DataKeyNames="codigo_actividad">
                            <Columns>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="codigo_actividad" FilterControlAltText="Filtro codigo_actividad" HeaderText="Código Actividad Economica" SortExpression="codigo_actividad" UniqueName="codigo_actividad" Resizable="true"  />
                                ...
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="nombre_actividad" FilterControlAltText="Filtro nombre_actividad" HeaderText="Actividad Economica" SortExpression="nombre_actividad" UniqueName="nombre_actividad" Resizable="true" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select *from PLD_Actividad_Economica order by cast (codigo_actividad as integer)" ConnectionString="<%$ ConnectionStrings:Taller %>">
                </asp:SqlDataSource>
                </asp:Panel>
            </asp:Panel>
