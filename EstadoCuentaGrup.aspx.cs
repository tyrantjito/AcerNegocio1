...
public partial class EstadoCuentaGrup : System.Web.UI.Page
{
    ...
    protected void lnkImprimirEdoCuentaGrup_Click(object sender, EventArgs e)
    {
        ...
        documento.AddTitle(" EstadoCuentaGrupo");
        documento.AddCreator("Desarrollarte");
        string ruta = HttpContext.Current.Server.MapPath("~/files");
        string archivo = ruta + "\\Estado_Cuenta_Grupales_" + fechas.obtieneFechaLocal().ToString("yyyy-MM-dd") + ".pdf";
        ...
        if (archivo.Trim() != "")
        {
            ...
            PdfPCell titulo = new PdfPCell(new Phrase("Estado de Cuenta Grupal", fuente6));
            ...
            EdoCuentGrup parame = new EdoCuentGrup();
            ...
            EdoCuentGrup encabez = new EdoCuentGrup();
            ...
            {
                DataSet para = (DataSet)encabez.retorno[1];


                foreach (DataRow r1 in para.Tables[0].Rows)
                {

                    grupoSol = r1[0].ToString();
                    numExt = r1[1].ToString();
                    calleGrup = r1[2].ToString();
                    colGrup = r1[3].ToString();
                   
                    sucurGrup=Convert.ToInt32( r1[4]);
                    municiGrup = r1[5].ToString();
                    asesorGrupo = r1[7].ToString();
                    localGrup = r1[6].ToString();
                    


                    PdfPCell grupSol = new PdfPCell(new Phrase("Grupo:", fuente4));
                    grupSol.HorizontalAlignment = Element.ALIGN_LEFT;
                    grupSol.Border = 0;
                    grupSol.VerticalAlignment = Element.ALIGN_MIDDLE;
                    detalleEnca.AddCell(grupSol);

                    PdfPCell grupSol1 = new PdfPCell(new Phrase(grupoSol, fuente4));
                    ...
                    PdfPCell calle1 = new PdfPCell(new Phrase(calleGrup, fuente4));
                    ...
                    PdfPCell colo1 = new PdfPCell(new Phrase(colGrup, fuente4));
                    ...
                    PdfPCell suc1 = new PdfPCell(new Phrase(sucurGrup.ToString(), fuente4));
                    ...
                    PdfPCell muni1 = new PdfPCell(new Phrase(municiGrup, fuente4));
                    ...
                    PdfPCell asesor1 = (new PdfPCell(new Phrase(asesorGrupo, fuente4)) { Colspan = 3 });
                    ...
                    PdfPCell local1 = new PdfPCell(new Phrase(localGrup, fuente4));
            ...
            int plazoGrup=0;
            decimal tasa = 0;
            decimal interesGrup = 0;
            decimal interesGrupaut = 0;
            decimal pagSemGrup = 0;
            decimal pagsemgrupaut = 0;
            decimal totPagar = 0;
            decimal totPagaraut = 0;
            decimal gl = 0;
            string creAutGrup = "";
            string  requeGrup = "";
            string fechaFin = "";
            ...
            {
                DataSet ds2 = (DataSet)deta.retorno[1];

                foreach (DataRow r2 in ds2.Tables[0].Rows)
                {
                    cicloGrup = Convert.ToInt32(r2[0]);
                    credito = Convert.ToInt32(r2[1]);
                    fecha = Convert.ToDateTime(r2[2]).ToString("yyyy/MM/dd");
                    fechaFin = Convert.ToDateTime(r2[10]).ToString("yyyy/MM/dd");
                    periodoGrup = Convert.ToInt32(r2[11]);
                    plazoGrup = Convert.ToInt32(r2[3]);
                    tasa = Convert.ToDecimal(r2[4]);
                    interesGrup = Convert.ToDecimal(r2[8]);
                    interesGrupaut = interesGrupaut + interesGrup;
                    pagSemGrup = Convert.ToDecimal(r2[5]);
                    pagsemgrupaut = pagsemgrupaut + pagSemGrup;
                    totPagar = Convert.ToDecimal(r2[9]);
                    totPagaraut = totPagaraut + totPagar;
                    gl = totPagaraut * Convert.ToDecimal(.10);
                    ...
                    PdfPCell clicloEtc = (new PdfPCell(new Phrase("Ciclo:  " + cicloGrup + "     Crédito:  " + credito + "      Inicio:  " + fecha+ "       Fin:   " + fechaFin + "        Periodos Transcurridos:       "+periodoGrup+"        ", fuente4)) { Colspan = 6 });
            ...
            PdfPCell etc = (new PdfPCell(new Phrase(" Autorizado: "+creAutGrup+" \n\n Devolución: \n\n Cartera Vencida: ", fuente4)) { Rowspan = 4 });
            ...
            PdfPCell garaLi = (new PdfPCell(new Phrase("Garantía Líquida\n\n "+gl.ToString("C2")+"", fuente4)) { Rowspan=2 });
            ...
            PdfPCell reque1 = new PdfPCell(new Phrase("", fuente4));
           ...
           for(int i=1;i<= plazoGrup; i++)
            ...
            {
                DataSet ds3 = (DataSet)enca.retorno[1];

                    foreach (DataRow r3 in ds3.Tables[0].Rows)
                    {
                        noPago = Convert.ToInt32(r3[6]);
                        fechaPago = Convert.ToDateTime(r3[7]).ToString("yyyy/MM/dd");
                        fechaApl = Convert.ToDateTime(r3[8]).ToString("yyyy/MM/dd");
                        referen = Convert.ToString(r3[9]);
                        pago = Convert.ToDecimal(r3[10]);
                        ap = Convert.ToDecimal(r3[13]);
                        abonoCli = abonoCli+ pago + ap;
