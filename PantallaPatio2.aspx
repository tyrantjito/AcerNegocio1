<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PantallaPatio2.aspx.cs" Inherits="PantallaPatio2" %>
                    ...
                    <div class="col-lg-12 col-sm-12 text-center">
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered" GridLines="None"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Entrega Promesa" SortExpression="f_entrega_estimada" >
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblFechaEstimada" Text='<%# Eval("f_entrega_estimada") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Entrega Pactada" SortExpression="f_pactada" >
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblFechaPactada" Text='<%# Eval("f_pactada") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Confirmación" SortExpression="f_confirmacion" >
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblFecchaConf" Text='<%# Eval("f_confirmacion") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Entrega" SortExpression="f_terminacion" >
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblFechaEntReal" Text='<%# Eval("f_terminacion") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
