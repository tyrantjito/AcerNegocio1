<%@ Page Title="" Language="C#" MasterPageFile="~/AdmOrdenes.master" AutoEventWireup="true" CodeFile="PLDTrabajo.aspx.cs" Inherits="PLDTrabajo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <telerik:RadFormDecorator ID="RadFormDecorator1" RenderMode="Lightweight" runat="server" DecoratedControls="Buttons" />
     ...
     <%-- Nueva Sucursal --%>
    <telerik:RadWindow RenderMode="Lightweight" ID="modalNuevo" Title="Nueva Forma de Trabajo" EnableShadow="true" Skin="Metro"
            ...
            <asp:UpdatePanel ID="UpdatePanelEmi" runat="server">
                <ContentTemplate>
                     <asp:Panel ID="Panel2" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left"><asp:Label Visible="false" ID="Label5" runat="server" Text="Código Forma de Trabajo:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left">
                          ...
                          <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label16" runat="server" Text="Forma de Trabajo:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left">
     ...
     <%-- Modifica Empresa --%>
    <telerik:RadWindow RenderMode="Lightweight" ID="modalModifica" Title="Edita Forma de Trabajo" EnableShadow="true" Skin="Metro"
            ...
            <asp:UpdatePanel ID="UpdatePanelEmiMod" runat="server">
                <ContentTemplate>
                     <asp:Panel ID="Panel1" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label2" runat="server" Text="Código de Forma de Trabajo:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left">
                            <asp:TextBox ID="txtCodEdoEdt" runat="server" CssClass="input-xxlarge" MaxLength="128" />
                           
                        </div>

                          <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label17" runat="server" Text="Forma de Trabajo:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left">
     ...
     <div class="row">
        <div class="col-lg-12 col-sm-12 text-center alert-info">
            <h3>
                ...
                <asp:Label ID="Label10" runat="server" Text="Catálogo de Formas de Trabajo"></asp:Label>
            </h3>
        </div>
    </div>
            ...
            <asp:Panel ID="pnlContenido" CssClass="col-lg-12 col-sm-12" runat="server" ScrollBars="Auto">
                <asp:Panel ID="pnlCatalogos" runat="server" CssClass="col-lg-12 col-sm-12" ScrollBars="Auto">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" AllowFilteringByColumn="true" OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged" runat="server" EnableHeaderContextMenu="true" Culture="es-Mx" Skin="Metro" 
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="false" DataKeyNames="codigo_ftrabajo">
                            <Columns>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="codigo_ftrabajo" FilterControlAltText="Filtro codigo_ftrabajo" HeaderText="Código Forma de Trabajo" SortExpression="codigo_ftrabajo" UniqueName="codigo_ftrabajo" Resizable="true"  />
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="nombre_ftrabajo" FilterControlAltText="Filtro nombre_ftrabajo" HeaderText="Forma de Trabajo" SortExpression="nombre_ftrabajo" UniqueName="nombre_ftrabajo" Resizable="true" />
                            </Columns>
                        </MasterTableView>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select codigo_ftrabajo, nombre_ftrabajo from PLD_Forma_De_Trabajo " ConnectionString="<%$ ConnectionStrings:Taller %>">
                </asp:SqlDataSource>
                </asp:Panel>
            </asp:Panel>
