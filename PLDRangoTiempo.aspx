<%@ Page Title="" Language="C#" MasterPageFile="~/AdmOrdenes.master" AutoEventWireup="true" CodeFile="PLDRangoTiempo.aspx.cs" Inherits="PLDRangoTiempo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <telerik:RadWindow RenderMode="Lightweight" ID="modalNuevo" Title="Nuevo Rango de Tiempo" EnableShadow="true" Skin="Metro"
            ...
            <asp:UpdatePanel ID="UpdatePanelEmi" runat="server">
                <ContentTemplate>
                     <asp:Panel ID="Panel2" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left"><asp:Label Visible="false" ID="Label5" runat="server" Text="Código Rango de Tiempo:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtCodRangoTiempoAdd" runat="server" Visible="false" CssClass="input-xxlarge" MaxLength="128" /></div>
                        ...
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtIdEscalaAdd" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label8" runat="server" Text="Rango Inicial en Años:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtRInicialAdd" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label9" runat="server" Text="Rango Final en Años:" CssClass="textoBold"></asp:Label></div>
     ...
     <%-- Modifica Rango de Tiempo --%>
    <telerik:RadWindow RenderMode="Lightweight" ID="modalModifica" Title="Edita Rango de Tiempo" EnableShadow="true" Skin="Metro"
            ...
            <asp:UpdatePanel ID="UpdatePanelEmiMod" runat="server">
                <ContentTemplate>
                     <asp:Panel ID="Panel1" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label2" runat="server" Text="Código de Rango de Tiempo:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtCodRangoTiempoEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>

                          <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label17" runat="server" Text="Escala:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtEscalaTiempoEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>

                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label3" runat="server" Text="Rango Inicial en años: " CssClass="textoBold"></asp:Label></div>
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label6" runat="server" Text="Rango Final en años: " CssClass="textoBold"></asp:Label></div>
     ...
     <div class="row">
        <div class="col-lg-12 col-sm-12 text-center alert-info">
            <h3>
                ...
                <asp:Label ID="Label10" runat="server" Text="Catálogo Rango de Tiempo"></asp:Label>
            </h3>
        </div>
    </div>
            ...
            <asp:Panel ID="pnlContenido" CssClass="col-lg-12 col-sm-12" runat="server" ScrollBars="Auto">
                <asp:Panel ID="pnlCatalogos" runat="server" CssClass="col-lg-12 col-sm-12" ScrollBars="Auto">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" AllowFilteringByColumn="true" OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged" runat="server" EnableHeaderContextMenu="true" Culture="es-Mx" Skin="Metro" 
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="false" DataKeyNames="codigo_rtiempo">
                            <Columns>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="codigo_rtiempo" FilterControlAltText="Filtro codigo_rtiempo" HeaderText="Código Rango de Tiempo" SortExpression="codigo_rtiempo" UniqueName="codigo_rtiempo" Resizable="true"  />
                                ...
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="inicial" FilterControlAltText="Filtro inicial" HeaderText="Rango Inicial en años" SortExpression="inicial" UniqueName="inicial" Resizable="true" />
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="final" FilterControlAltText="Filtro final" HeaderText="Rango Final en años" SortExpression="final" UniqueName="final" Resizable="true" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select *from PLD_Rango_Tiempo order by cast(codigo_rtiempo as int)" ConnectionString="<%$ ConnectionStrings:Taller %>">
                </asp:SqlDataSource>
                </asp:Panel>
            </asp:Panel>
