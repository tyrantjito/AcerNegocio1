<%@ Page Title="" Language="C#" MasterPageFile="~/AdmonOrden.master" AutoEventWireup="true" CodeFile="Fondeo.aspx.cs" Inherits="Fondeo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <ContentTemplate>
                    <asp:Panel ID="pnlPrincipal" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-9 col-sm-9 text-left">
                                <asp:DropDownList ID="cmb_analista" runat="server" AutoPostBack="true" AppendDataBoundItems="true"  DataSourceID="cmbNombre" DataValueField="id_lineaFondeo"
                                    DataTextField="fondeador">
                                    <asp:ListItem Value="0">Selecciona Linea de Fondeo</asp:ListItem>
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="cmbNombre" runat="server" ConnectionString="<%$ ConnectionStrings:Taller %>" SelectCommand="select * from AN_Linea_fondeo ">
                                    <SelectParameters>
    ...
    <telerik:RadWindow RenderMode="Lightweight" ID="modalModifica" Title="Edita Moneda" EnableShadow="true" Skin="Metro"
      ...
      <div class="page-header">
                <!-- /BREADCRUMBS -->
                <div class="clearfix">
                    <h3 class="content-title pull-left">Asignar Linea de Fondeo</h3>
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>            
            ...
            <asp:Panel ID="pnlContenido" CssClass="col-lg-12 col-sm-12" runat="server" ScrollBars="Auto">
                <asp:Panel ID="pnlCatalogos" runat="server" CssClass="col-lg-12 col-sm-12" ScrollBars="Auto">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" AllowFilteringByColumn="true"  OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged" runat="server" EnableHeaderContextMenu="true" Culture="es-Mx" Skin="Metro" 
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="false" DataKeyNames="id_lineaFondeo">
                           <Columns>
                               <telerik:GridBoundColumn HeaderStyle-Width="25%" FilterCheckListEnableLoadOnDemand="true" DataField="fondeador" FilterControlAltText="Filtro Fondeador" HeaderText="Fondeador" SortExpression="fondeador" UniqueName="fondeador"  />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select f.id_lineaFondeo,f.Fondeador, c.id_grupo,c.grupo_productivo,c.ciclo from an_creditos c left join an_linea_fondeo f on f.id_lineafondeo = c.id_Fondeo where id_solicitud_credito=@grupo" ConnectionString="<%$ ConnectionStrings:Taller %>">
                     <SelectParameters>
