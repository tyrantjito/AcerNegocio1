<%@ Page Title="" Language="C#" MasterPageFile="~/AdmOrdenes.master" AutoEventWireup="true" CodeFile="FacturacionGral.aspx.cs" Inherits="FacturacionGral" Culture="es-Mx" UICulture="es-Mx" %>
                ...
                <ContentTemplate>
                    <asp:Panel ID="pnlPrincipal" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-12 col-sm-12 text-center">
                            <asp:Label ID="lblErrorEmisores" runat="server" CssClass="errores"></asp:Label></div>
                            ...
                            <telerik:RadMultiPage runat="server" ID="multiPaginaEmi" SelectedIndex="0" SkinID="MetroTouch">
                                <telerik:RadPageView runat="server" ID="vDomicilioEmi">
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label7" runat="server" Text="Calle:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblCalleEmi" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label9" runat="server" Text="Número Exterior:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblNoExtEmi" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label11" runat="server" Text="Número Interior:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblNoIntEmi" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label13" runat="server" Text="Colonia:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblColoniaEmi" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label14" runat="server" Text="Delegación/Municipio:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblDelMunEmi" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label15" runat="server" Text="Estado:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblEdoEmi" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label16" runat="server" Text="País:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblPaisEmi" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label17" runat="server" Text="Código Postal:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblCpEmi" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label18" runat="server" Text="Ciudad/Localidad:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblLocalidadEmi" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label19" runat="server" Text="Referencia:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblReferenciaEmi" runat="server"></asp:Label></div>
                                </telerik:RadPageView>
                                <telerik:RadPageView runat="server" ID="vExpedicionEmi">
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label20" runat="server" Text="Calle:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblCalleEx" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label21" runat="server" Text="Número Exterior:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblNoExtEx" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label22" runat="server" Text="Número Interior:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblNoIntEx" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label23" runat="server" Text="Colonia:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblColoniaEx" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label24" runat="server" Text="Delegación/Municipio:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblDelMunEx" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label25" runat="server" Text="Estado:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblEdoEx" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label26" runat="server" Text="País:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblPaisEx" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label27" runat="server" Text="Código Postal:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblCpEx" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label29" runat="server" Text="Ciudad/Localidad:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblLocalidadEx" runat="server"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="Label31" runat="server" Text="Referencia:" CssClass="textoBold"></asp:Label></div>
                                    <div class="col-lg-3 col-sm-3 text-left">
                                        <asp:Label ID="lblReferenciaEx" runat="server"></asp:Label></div>
                                </telerik:RadPageView>
            ...
            <asp:UpdatePanel ID="UpdatePanelRec" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="pnlPrincipalReceptores" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-12 col-sm-12 text-center"><asp:Label ID="lblErrorRec" runat="server" CssClass="errores"></asp:Label></div>
                        <div class="col-lg-12 col-sm-12">    
                            
                            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" EnableAJAX="true">
                            <telerik:RadGrid RenderMode="Lightweight" ID="grdReceptores" AllowFilteringByColumn="true" runat="server"  EnableHeaderContextMenu="true" Culture="es-Mx" Skin="Metro" OnSelectedIndexChanged="grdReceptores_SelectedIndexChanged1"
                                EnableHeaderContextFilterMenu="true" AllowPaging="True" PagerStyle-AlwaysVisible="true" AllowSorting="true" GroupingEnabled="false" PageSize="50"  DataSourceID="SqlDataSource2">                        
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:eFactura %>" SelectCommand="select IdRecep,ReRFC,ReNombre from receptores"/>                
                        ...
                        <div class="col-lg-12 col-sm-12 marTop9px"> 
                            ...
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label48" runat="server" Text="Calle:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblCalleRec" runat="server"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label54" runat="server" Text="Número Exterior:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblNoExtRec" runat="server"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label58" runat="server" Text="Número Interior:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblNoIntRec" runat="server"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label62" runat="server" Text="Colonia:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblColoniaRec" runat="server"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label65" runat="server" Text="Delegación/Municipio:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblDelMunRec" runat="server"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label67" runat="server" Text="Estado:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblEdoRec" runat="server"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label69" runat="server" Text="País:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblPaisRec" runat="server"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label71" runat="server" Text="Código Postal:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblCpRec" runat="server"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label73" runat="server" Text="Ciudad/Localidad:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblLocalidadRec" runat="server"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label75" runat="server" Text="Referencia:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblReferenciaRec" runat="server"></asp:Label></div>
                                <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label34" runat="server" Text="Correo Electrónico:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblCorreoRec" runat="server"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label40" runat="server" Text="Correo CC:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblCorreoCCRec" runat="server"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="Label50" runat="server" Text="Correo CCO:" CssClass="textoBold"></asp:Label></div>
                            <div class="col-lg-3 col-sm-3 text-left">
                                <asp:Label ID="lblCorreoCCORec" runat="server"></asp:Label></div>                                
                        </div>
                    </asp:Panel>
            ...
            <asp:Panel runat="server" ID="pnlDaños" CssClass="col-lg-12 col-sm-12" >
                ...
                <telerik:RadMultiPage runat="server" ID="multiPagina" SelectedIndex="0" SkinID="MetroTouch">
                    <telerik:RadPageView runat="server" ID="vEmisor">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label5" runat="server" Text="Calle:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblCalleEmiFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label30" runat="server" Text="Número Exterior:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblNoExtEmiFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label33" runat="server" Text="Número Interior:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblNoIntEmiFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label35" runat="server" Text="Colonia:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblColoniaEmiFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label37" runat="server" Text="Delegación/Municipio:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblDelMunEmiFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label39" runat="server" Text="Estado:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblEdoEmiFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label41" runat="server" Text="País:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblPaisEmiFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label43" runat="server" Text="Código Postal:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblCpEmiFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label45" runat="server" Text="Ciudad/Localidad:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblLocalidadEmiFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label47" runat="server" Text="Referencia:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblReferenciaEmiFac" runat="server"></asp:Label></div>
                    ...
                    <telerik:RadPageView runat="server" ID="vExpedicion">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label38" runat="server" Text="Calle:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblCalleEmiExFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label42" runat="server" Text="Número Exterior:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblNoExtEmiExFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label46" runat="server" Text="Número Interior:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblNoIntEmiExFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label49" runat="server" Text="Colonia:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblColoniaEmiExFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label53" runat="server" Text="Delegación/Municipio:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblDelMunEmiExFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label55" runat="server" Text="Estado:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblEdoEmiExFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label57" runat="server" Text="País:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblPaisEmiExFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label59" runat="server" Text="Código Postal:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblCpEmiExFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label61" runat="server" Text="Ciudad/Localidad:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblLocalidadEmiExFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label63" runat="server" Text="Referencia:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblReferenciaEmiExFac" runat="server"></asp:Label></div>
                    </telerik:RadPageView>
                    <telerik:RadPageView runat="server" ID="vReceptor">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label64" runat="server" Text="Calle:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblCalleRecFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label68" runat="server" Text="Número Exterior:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblNoExtRecFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label72" runat="server" Text="Número Interior:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblNoIntRecFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label76" runat="server" Text="Colonia:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblColoniaRecFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label78" runat="server" Text="Delegación/Municipio:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblDelMunRecFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label80" runat="server" Text="Estado:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblEdoRecFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label82" runat="server" Text="País:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblPaisRecFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label84" runat="server" Text="Código Postal:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblCpRecFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label86" runat="server" Text="Ciudad/Localidad:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblLocalidadRecFac" runat="server"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label88" runat="server" Text="Referencia:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="lblReferenciaRecFac" runat="server"></asp:Label></div>
                            </telerik:RadAjaxPanel>
                    </telerik:RadPageView>
                    ...
                    <telerik:RadPageView runat="server" ID="vAdicional">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label89" runat="server" Text="Tipo de Cambio:" CssClass="textoBold"></asp:Label></div>
                        ...
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label91" runat="server" Text="Nota:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label93" runat="server" Text="Referencia Externa/Documento de Referencia:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left">
                            <asp:Label ID="Label95" runat="server" Text="Folio de Impresión:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left">
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Concepto" UniqueName="Concepto">                                                
                                                <ItemTemplate> 
                                                    <table style="text-align:center;">
                                                        <tr><td>ID: <asp:TextBox ID="txtIdent" runat="server" CssClass="input-small" /></td></tr>
                                                        <tr><td>Concepto:<br /><asp:TextBox runat="server" ID="txtConcepto" TextMode="MultiLine" Columns="15" Rows="5" CssClass="textNota" /></td></tr>
                                                    </table>
                                                </ItemTemplate> 
                                                ...
                                                <ItemTemplate> 
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td class="text-right"><telerik:RadNumericTextBox ID="radnumCantidad" runat="server" Font-Size="Small" MaxValue="10000" MinValue="1" Value="1" CssClass="input-mini" Width="80" NumberFormat-AllowRounding="False" ShowButton="False" AutoPostBack="true" ShowSpinButtons="True" OnTextChanged="radnumCantidad_TextChanged"></telerik:RadNumericTextBox></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-left">Unidad:</td>
                                                            <td class="text-right"><asp:DropDownList ID="ddlUnidad" runat="server" DataSourceID="SqlDsUnidad" DataTextField="UnidDesc" DataValueField="IdUnid" CssClass="input-small"></asp:DropDownList></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-left">Valor Unitario:</td>
                                                            <td class="text-right"><asp:TextBox ID="txtValUnit" runat="server" Columns="2" Text="0.00" AutoPostBack="true" OnTextChanged="txtValUnit_TextChanged" ></asp:TextBox>
                                                                <cc1:FilteredTextBoxExtender ID="filtxtValUnit" runat="server" TargetControlID="txtValUnit" FilterType="Custom, Numbers" ValidChars="." /></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-left">Importe:</td>
                                                            <td class="text-right"><asp:Label ID="lblImporte" runat="server" Text="0.00"></asp:Label></td>
                                                        </tr>
                                                    </table>
                                                </ItemTemplate> 
                                            </telerik:GridTemplateColumn>
                                                ...
                                                <ItemTemplate> 
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td class="text-right"><asp:TextBox ID="txtPtjeDscto" runat="server" Text="0" Columns="1" MaxLength="5" AutoPostBack="true" OnTextChanged="txtPtjeDscto_TextChanged"></asp:TextBox></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-left">Descuento: </td>
                                                            <td class="text-right"><asp:TextBox ID="txtDscto" runat="server" Text="0.00" Columns="2" AutoPostBack="true" OnTextChanged="txtDscto_TextChanged"></asp:TextBox>
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="filtxtDscto" runat="server" TargetControlID="txtDscto" FilterType="Custom, Numbers" ValidChars="." /></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-left">Dto. Global: </td>
                                                            <td class="text-right"><asp:Label ID="lblDtoGlobalConcepto" runat="server" Text="0.00"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-left">SubTotal:</td>
                                                            <td class="text-right"><asp:Label ID="lblSubTotal" runat="server" Text="0.00"></asp:Label></td>
                                                        </tr>
                                                    </table>
                                                </ItemTemplate> 
                                            </telerik:GridTemplateColumn> 
                                            <telerik:GridTemplateColumn UniqueName="Imp_Tras" HeaderText="Impuestos Trasladados"> 
                                                <ItemTemplate>
                                                    <table class="text-left">
                                                        <tr>
                                                          <td class="text-left"><telerik:RadDropDownList runat="server" ID="ddlIvaTras" DataSourceID="SqlDSIva" DataTextField="TrasDescrip" DataValueField="Id_Tras" Width="100" DefaultMessage="Elija IVA" OnClientItemSelected="" AutoPostBack="true" OnSelectedIndexChanged="ddlIvaTras_SelectedIndexChanged"></telerik:RadDropDownList></td>
                                                          <td class="text-right"><asp:Label runat="server" ID="lblIvaTras" Text="0.00"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                          <td class="text-left"><telerik:RadDropDownList ID="ddlIeps" runat="server" DataSourceID="SqlDSIeps" DataTextField="TrasDescrip" DataValueField="Id_Tras" DefaultMessage="Elija IEPS" Width="100" OnClientItemSelected="" AutoPostBack="true" OnSelectedIndexChanged="ddlIeps_SelectedIndexChanged"></telerik:RadDropDownList></td>
                                                          <td class="text-right"><asp:Label runat="server" ID="lblIeps" Text="0.00"></asp:Label></td>
                                                        </tr>
                                                    </table>
                                                    <br />
                                                </ItemTemplate> 
                                                        ...
                                                        <tr>
                                                          <td class="text-left">
                                                            <telerik:RadDropDownList runat="server" ID="ddlIvaRet" DataSourceID="SqlDsIvaRet" DataTextField="RetDescrip" DataValueField="Id_Ret" Width="100" AutoPostBack="true"
                                                                DefaultMessage="Elija IVA" OnClientItemSelected="" OnSelectedIndexChanged="ddlIvaRet_SelectedIndexChanged"></telerik:RadDropDownList>
                                                          </td>
                                                          <td class="text-right">
                                                        ...
                                                        <tr>
                                                          <td class="text-left">
                                                              <telerik:RadDropDownList ID="ddlIsrRet" runat="server" DataSourceID="SqlDsIsrRet" DataTextField="RetDescrip" DataValueField="Id_Ret" AutoPostBack="true"
                                                               OnSelectedIndexChanged="ddlIsrRet_SelectedIndexChanged"  DefaultMessage="Elija ISR" Width="100"></telerik:RadDropDownList>
                                                          </td>
                                                          <td class="text-right">
                           ...
                           <EmptyDataTemplate>
                              <table class="pad1m">
                                <tr>
                                    ...
                                    <td><asp:Label ID="lblSubTotBru" runat="server" Text="0.00"></asp:Label></td>
                                    <td style="width:100px;">&nbsp;</td>
                                    <td>Impuesto Trasladado:</td>
                                    <td><asp:Label ID="lblImpTras" runat="server" Text="0.00"></asp:Label></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><asp:Label ID="lblSubTotTras" runat="server" Text="0.00"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td>Descuento:</td>
                                    <td><asp:Label ID="lblTotDscto" runat="server" Text="0.00" ></asp:Label></td>
                                    <td style="width:100px;">&nbsp;</td>
                                    <td>Impuesto Retenido:</td>
                                    <td><asp:Label ID="lblImpRet" runat="server" Text="0.00"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td>Subtotal Neto:</td>
                                    <td><asp:Label ID="lblSubTotNeto" runat="server" Text="0.00"></asp:Label></td>
                                    <td style="width:100px;">&nbsp;</td>
                                    <td>Subtotal despu&eacute;s de retenciones:</td>
                                    <td><asp:Label ID="lblSubTotRet" runat="server" Text="0.00"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td><asp:Label runat="server" ID="lblMotDscto" Text="Motivo del Descuento:"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtMotivoDscto" Columns="10"></asp:TextBox></td>
                                    <td style="width:100px;">&nbsp;</td>
                                    <td>Traslados y retenciones adicionales:</td>
                                    <td><asp:Label ID="lblTrasRetAd" runat="server" Text="0.00"></asp:Label></td>
                                </tr>
                                 <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td style="width:100px;">&nbsp;</td>
                                    <td>Total:</td>
                                    <td><asp:Label ID="lblTotalGral" runat="server" Text="0.00"></asp:Label></td>
                                </tr>
                              </table>
                           </EmptyDataTemplate>
                           <ItemTemplate>
                                <table class="pad1m">
                                    ...
                                    <tr>
                                        <td>Descuento Global:</td>
                                        <td><asp:TextBox ID="txtPctjeDsctoGlb" runat="server" Text='<%# string.IsNullOrEmpty(Eval("EncDescGlob").ToString()) ? "0.00" : Eval("EncDescGlob") %>'  Columns="1" CssClass="input-small" OnTextChanged="txtPctjeDsctoGlb_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            %&nbsp;
                                    ...
                                    <tr>
                                        <td>Descuento:</td>
                                        <td><asp:Label ID="lblTotDscto" runat="server" Text='<%# string.IsNullOrEmpty(Eval("EncDesc").ToString()) ? "0.00" : Eval("EncDesc") %>' ></asp:Label></td>
                                        <td style="width:100px;">&nbsp;</td>
                                        <td>Impuesto Retenido:</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><asp:Label runat="server" ID="lblMotDscto" Text="Motivo del Descuento:" Visible="false"></asp:Label></td>
                                        <td><asp:TextBox runat="server" ID="txtMotivoDscto" Text='<%# Eval("EncMotivoDescuento") %>' Columns="10" Visible="false"></asp:TextBox></td>
                                        <td style="width:100px;">&nbsp;</td>
                                        <td>
                                            Traslados y retenciones adicionales:
                                        </td>
                                        <td>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            ...
            <asp:Panel runat="server" ID="Panel1" CssClass="col-lg-12 col-ms-12 text-center pad1m">                
                <div class="col-lg-4 col-ms-4 text-center">                    
