...
public partial class ControlPagoSemanal : System.Web.UI.Page
{
    ...
    protected void lnkImprimirControlPagoSemanal_Click(object sender, EventArgs e)
    {
        ...
        documento.AddTitle("CONTROL DE PAGOS SEMANALES");
        documento.AddCreator("AserNegocio");
        string ruta = HttpContext.Current.Server.MapPath("~/files");
        string archivo = ruta + "\\Cotrol_d_Pagos_Semanales_" + fechas.obtieneFechaLocal().ToString("yyyy-MM-dd") + ".pdf";
        ...
        if (archivo.Trim() != "")
        {
            ...
            PdfPCell horrocrux34 = (new PdfPCell(new Phrase("\n\n\n\n\n  ", fuente8)));
            horrocrux34.HorizontalAlignment = Element.ALIGN_CENTER;
            horrocrux34.VerticalAlignment = Element.ALIGN_MIDDLE;
            firmpie.AddCell(horrocrux34);
            ...
            PdfPCell horrocrux8 = (new PdfPCell(new Phrase("VOCAL 1", fuente8)));
            ...
            PdfPCell horrocrux38 = (new PdfPCell(new Phrase("VOCAL 2", fuente8)));
            horrocrux38.HorizontalAlignment = Element.ALIGN_CENTER;
            horrocrux38.VerticalAlignment = Element.ALIGN_MIDDLE;
            firmpie.AddCell(horrocrux38);
            ...
            PdfPTable firmpie2 = new PdfPTable(5);
            firmpie2.SetWidths(new float[] { 20, 20, 20, 20, 20 });
            ...
            PdfPCell horrocrux25 = (new PdfPCell(new Phrase("\n\n\n\n\n  ", fuente8)));
            horrocrux25.HorizontalAlignment = Element.ALIGN_CENTER;
            horrocrux25.VerticalAlignment = Element.ALIGN_MIDDLE;
            firmpie2.AddCell(horrocrux25);
            ...
            PdfPCell horrocrux19 = (new PdfPCell(new Phrase("VOCAL1", fuente8)));
            ...
            PdfPCell horrocrux29 = (new PdfPCell(new Phrase("VOCAL2", fuente8)));
            horrocrux29.HorizontalAlignment = Element.ALIGN_CENTER;
            horrocrux29.VerticalAlignment = Element.ALIGN_MIDDLE;
            firmpie2.AddCell(horrocrux29);
