<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BitLocalizacionOrden.aspx.cs" Inherits="BitLocalizacionOrden" MasterPageFile="~/AdmonOrden.master" Culture="es-Mx" UICulture="es-Mx"%>
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 text-center alert-info">
                    <h3>
                        ...
                        <asp:Label ID="Label1" runat="server" Text="Bitácora de Localización"></asp:Label>                        
                    </h3>                    
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="col-lg-12 col-sm-12">                                            
                        <asp:Panel ID="Panel1" runat="server" CssClass="panelCatalogos text-center" ScrollBars="Auto">
                           <div class="table-responsive">
                               ...
                               SelectCommand="select l.descripcion,convert(char(10),b.fecha,126) as fecha,convert(char(8),b.hora,126) as hora,u.nombre_usuario from bitacora_orden_localizacion b inner join usuarios u on u.id_usuario=b.id_usuario inner join localizaciones l on l.id_localizacion=b.id_localizacion where b.id_empresa=@empresa and b.id_taller=@taller and b.no_orden=@orden order by b.id_registro desc">
                                   <SelectParameters>
