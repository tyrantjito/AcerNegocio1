<%@ Page Title="" Language="C#" MasterPageFile="~/AdmonOrden.master" AutoEventWireup="true" CodeFile="Politicas.aspx.cs" Inherits="Politicas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
     <script type="text/javascript">
         function abreNewEmiPol() {
            var oWnd = $find("<%=modalNuevo.ClientID%>");
            oWnd.setUrl('');
            oWnd.show();
        }

        function cierraNewEmiPol() {
            var oWnd = $find("<%=modalNuevo.ClientID%>");
            oWnd.close();
        }
          function abreModEmiPol() {
            var oWnd = $find("<%=modalModifica.ClientID%>");
            oWnd.setUrl('');
            oWnd.show();
        }

        function cierraModEmiPol() {
            var oWnd = $find("<%=modalModifica.ClientID%>");
            oWnd.close();
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <asp:UpdatePanel ID="UpdatePanelEmi" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="pnlPrincipal" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-9 col-sm-9 text-left">
                            <asp:TextBox ID="txtPolID" Visible="false" runat="server" MaxLength="100" CssClass="input-xxlarge"></asp:TextBox>
                        </div>
                ...
                <ContentTemplate>
                    <asp:Panel ID="Panel1" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-9 col-sm-9 text-left">
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"></div>
                        <div class="col-lg-9 col-sm-9 text-left">
                            <asp:TextBox ID="txtidpol" Visible="false" runat="server" MaxLength="100" CssClass="input-xxlarge"></asp:TextBox>
                        </div>
   ...
   <div class="page-header">
                <!-- /BREADCRUMBS -->
                <div class="clearfix">
                    <h3 class="content-title pull-left">Políticas</h3>
     ...
     <div class="col-lg-12 col-sm-12 text-right">
                ...
                <asp:LinkButton ID="btnPoliticas" runat="server" CssClass="btn btn-info t14" OnClick="btnPoliticas_Click" ><i class="fa fa-thumbs-o-up"></i>&nbsp;<span>Politicas</span></asp:LinkButton>
                     </div>
            </div>
    <br /><br />
          <br /><br />
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" EnableAJAX="true">
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid2" AllowFilteringByColumn="true"  runat="server" Height="280"  EnableHeaderContextMenu="true" OnItemDataBound="RadGrid2_ItemDataBound" Culture="es-Mx" Skin="Metro" 
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" SelectCommand="select  d.id_cliente,d.nombre_cliente,d.ciclo,g.EstatusCompleto from AN_Solicitud_Credito_Detalle d left join AN_PoliticasGrupos g on d.id_cliente = g.Id_Cliente where g.id_credito=@grupo and g.Id_politica=1 " ConnectionString="<%$ ConnectionStrings:Taller %>">
                    <SelectParameters>
           ...
           <ContentTemplate>
               <asp:Panel ID="pnlMask" runat="server" CssClass="mask zen1" Visible="false" />
                ...
                <div class="clearfix">
                    ...
                    <h3 class="content-title center">Politicas Cliente
                    </h3>
                </div>
            </div></tr>
                </table>
        ...
        <ContentTemplate>            
            ...
            <div class="row pad1m">
                <div class="col-lg-12 col-sm-12 text-center">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" Height="650"  OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged" runat="server" EnableHeaderContextMenu="true" Culture="es-Mx" Skin="Metro" OnItemDataBound="RadGrid1_ItemDataBound"
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="false" DataKeyNames="id_politica">
                            <Columns>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="id_Politica" HeaderText="Clave" SortExpression="id_Politica" UniqueName="id_Politica" HeaderStyle-Width="5%"  Resizable="true"  />
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="Descripcion" HeaderText="Descripción" SortExpression="Descripcion" UniqueName="Descripcion" Resizable="true"  HeaderStyle-Width="20%" />
                                <telerik:GridTemplateColumn FilterCheckListEnableLoadOnDemand="true" HeaderText="Cumple"    HeaderStyle-Width="5%" >
                                <ItemTemplate>
                                     <asp:LinkButton ID="btnAprovar"  runat="server" CommandArgument='<%# Eval("id_Politica") %>' CssClass="btn btn-grey t14"  OnClick="btnAprovar_Click1" ><i class="fa fa-check"></i>&nbsp;<span></span></asp:LinkButton>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>   
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnNOAprovar" CssClass="btn btn-danger" runat="server"  CommandArgument='<%# Bind("id_Politica") %>'  OnClick="btnNOAprovar_Click" Text="No Cumple" ><i class="fa fa-remove"></i></asp:LinkButton>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>   
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="Observacion"  HeaderText="Observación" SortExpression="Observacion" UniqueName="Observacion" Resizable="true" HeaderStyle-Width="20%" />
                                <telerik:GridTemplateColumn FilterCheckListEnableLoadOnDemand="true" HeaderText=""    HeaderStyle-Width="6%" >
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnEditar" visible="false" CssClass="btn btn-warning" runat="server"  CommandArgument='<%# Bind("id_Politica") %>'   OnClick="btnEditar_Click1"  Text="Cambiar" ></asp:LinkButton>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>   
                            </Columns>
                        </MasterTableView>
