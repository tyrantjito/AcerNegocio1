<%@ Page Title="" Language="C#" MasterPageFile="~/AdmOrdenes.master" AutoEventWireup="true" CodeFile="PLDEstados.aspx.cs" Inherits="PLDEstados" %>
                ...
                <ContentTemplate>
                     <asp:Panel ID="Panel2" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-9 col-sm-9 text-left">
                          ...
                          <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label16" runat="server" Text="Nombre Estado:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left">
            ...
            <asp:UpdatePanel ID="UpdatePanelEmiMod" runat="server">
                <ContentTemplate>
                     <asp:Panel ID="Panel1" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label2" runat="server" Text="Código de Estado:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left">
                            <asp:TextBox ID="txtCodEdoEdt" runat="server" CssClass="input-xxlarge" MaxLength="128" />
                           
                        </div>

                          <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label17" runat="server" Text="Nombre Estado:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left">
            ...
            <asp:Panel ID="pnlContenido" CssClass="col-lg-12 col-sm-12" runat="server" ScrollBars="Auto">
                <asp:Panel ID="pnlCatalogos" runat="server" CssClass="col-lg-12 col-sm-12" ScrollBars="Auto">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" AllowFilteringByColumn="true" OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged" runat="server" EnableHeaderContextMenu="true" Culture="es-Mx" Skin="Metro" 
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="false" DataKeyNames="codigo_estado">
                            <Columns>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="codigo_estado" FilterControlAltText="Filtro codigo_estado" HeaderText="Código Estado" SortExpression="codigo_estado" UniqueName="codigo_estado" Resizable="true"  />
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="nombre_estado" FilterControlAltText="Filtro nombre_estado" HeaderText="Nombre Estado" SortExpression="nombre_estado" UniqueName="nombre_estado" Resizable="true" />
                            </Columns>
                        </MasterTableView>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select codigo_estado, nombre_estado from PLD_Estados " ConnectionString="<%$ ConnectionStrings:Taller %>">
                </asp:SqlDataSource>
                </asp:Panel>
            </asp:Panel>
