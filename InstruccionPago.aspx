<%@ Page Title="" Language="C#" MasterPageFile="~/AdmonOrden.master" AutoEventWireup="true" CodeFile="InstruccionPago.aspx.cs" Inherits="InstruccionPago" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="true">
          ...
          <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
              <ContentTemplate>
                ...
                <!-- /BREADCRUMBS -->
                <div class="clearfix">
                    <h3 class="content-title pull-left">Instrucción de Pago</h3>
                    <asp:Label ID="Label8" runat="server" CssClass="alert-danger"></asp:Label>
                </div>
            </div>
                 <asp:Label ID="Label15" runat="server" Visible="false" ></asp:Label>
                   <div class="row marTop text-center">
                      <asp:LinkButton ID="lnkImprimir" runat="server" Visible="true" ToolTip="Imprimir Pagare" OnClick="lnkImprimir_Click" CssClass="btn btn-info"><i class="fa fa-print"></i>&nbsp;<span>Imprimir Instrucción de Pago</span></asp:LinkButton>
                  </div>
                     
                  <br />
                   <br /> <br />

                    <telerik:RadAjaxPanel Visible="false" ID="RadAjaxPanel2" runat="server" EnableAJAX="true">
