<%@ Page Title="" Language="C#" MasterPageFile="~/AdmOrdenes.master" AutoEventWireup="true" CodeFile="PLDPropositoCuenta.aspx.cs" Inherits="PLDPropositoCuenta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <telerik:RadFormDecorator ID="RadFormDecorator1" RenderMode="Lightweight" runat="server" DecoratedControls="Buttons" />
     ...
     <%-- Nuevo Proposito de Cuenta --%>
    <telerik:RadWindow RenderMode="Lightweight" ID="modalNuevo" Title="Nuevo Proposito de Cuenta" EnableShadow="true" Skin="Metro"
                ...
                <ContentTemplate>
                     <asp:Panel ID="Panel2" runat="server" CssClass="ancho100 text-center">
                        <div class="col-lg-12 col-sm-12 text-center">
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label5" runat="server" visible="false" Text="Código de Cuenta:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtIDProductoAdd" Visible="false" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>

                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label6" runat="server"  Text="Nombre de Cuenta:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtNombreCuentaAdd"  runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
     ...
     <%-- Modifica Proposito de Cuenta --%>
    <telerik:RadWindow RenderMode="Lightweight" ID="modalModifica" Title="Editar Proposito de Cuenta" EnableShadow="true" Skin="Metro"
                ...
                <ContentTemplate>
                     <asp:Panel ID="Panel1" runat="server" CssClass="ancho100 text-center">
                        <div class="col-lg-12 col-sm-12 text-center">
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label7" runat="server" Text="ID de Cuenta:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtIDProductoEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label2" runat="server" Text="Nombre de Cuenta:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtNombreCuentaEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
            ...
            <asp:Panel ID="pnlContenido" CssClass="col-lg-12 col-sm-12" runat="server" ScrollBars="Auto">
                <asp:Panel ID="pnlCatalogos" runat="server" CssClass="col-lg-12 col-sm-12" ScrollBars="Auto">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" AllowFilteringByColumn="true" OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged" runat="server" EnableHeaderContextMenu="true" Culture="es-Mx" Skin="Metro" 
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="false" DataKeyNames="codigo_pproducto">
                            <Columns>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="codigo_pproducto" FilterControlAltText="Filtro codigo_pproducto" HeaderText="Codigo de Cuenta" SortExpression="codigo_pproducto" UniqueName="codigo_pproducto" Resizable="true" />
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="nombre_pproducto" FilterControlAltText="Filtro nombre_pproducto" HeaderText="Cuenta" SortExpression="nombre_pproducto" UniqueName="nombre_pproducto" Resizable="true"  />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select *from PLD_Proposito_Cuenta order by cast (codigo_pproducto as int)" ConnectionString="<%$ ConnectionStrings:Taller %>">
                </asp:SqlDataSource>
                </asp:Panel>
            </asp:Panel>
