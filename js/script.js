...
//SE ELIMINO ESTA FUNCIONALIDAD PARA LA VISUALIZACION DE LOS CATALOGOS
...
// SECREO ESTA FUNCION PARA LA VISUALIZACION DE REPORTE, PARA VISUALIZAR LA INFORMACION EN DATATABLE SIMPLE
	...
	return {
        ...
        init: function () {
			...
			// Nuevo manejador para reportes
			if (App.isPage("reportes")) {
				handleDataTables2();	//Function to display data tables
			}
