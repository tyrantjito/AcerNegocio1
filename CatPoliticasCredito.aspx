<%@ Page Title="" Language="C#" MasterPageFile="~/AdmOrdenes.master" AutoEventWireup="true" CodeFile="CatPoliticasCredito.aspx.cs" Inherits="CatPoliticasCredito" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <%--agregar política --%>
       <telerik:RadWindow RenderMode="Lightweight" ID="modalNuevo" Title="Nueva Política de Crédito" EnableShadow="true" Skin="Metro"
            ...
            <asp:UpdatePanel ID="UpdatePanelEmi" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="pnlPrincipal" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label4" runat="server" Text="ID Política:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left">
                            <asp:TextBox ID="txtIdPoli" runat="server" CssClass="input-xxlarge" MaxLength="128" />                            
                                                     
                        </div>

                        <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label5" runat="server" Text="Descripción" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left">
                            <asp:TextBox ID="txtDescrip" runat="server" MaxLength="100" CssClass="input-xxlarge"></asp:TextBox>                                                      
                        </div>
    ...
    <%--editar politica --%>
    <telerik:RadWindow RenderMode="Lightweight" ID="modalModifica" Title="Edita Política de Crédito" EnableShadow="true" Skin="Metro"
            ...
            <asp:UpdatePanel ID="UpdatePanelEmiMod" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="Panel1" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-9 col-sm-9 text-left">
                            <asp:TextBox ID="txtPoliEd" runat="server" CssClass="input-xxlarge" MaxLength="128" />                            
    ...
    <div class="page-header">
                <!-- /BREADCRUMBS -->
                <div class="clearfix">
                    <h3 class="content-title pull-left">Políticas de Crédito</h3>
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>            
            ...
            <asp:Panel ID="pnlContenido" CssClass="col-lg-12 col-sm-12" runat="server" ScrollBars="Auto">
                <asp:Panel ID="pnlCatalogos" runat="server" CssClass="col-lg-12 col-sm-12" ScrollBars="Auto">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" AllowFilteringByColumn="true" OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged" runat="server" EnableHeaderContextMenu="true" Culture="es-Mx" Skin="Metro" 
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="false" DataKeyNames="Id_politica">
                            <Columns>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="Id_politica" FilterControlAltText="Filtro Id_politica" HeaderText="ID Política" SortExpression="Id_politica" UniqueName="Id_politica" Resizable="true"  />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select * from AN_Politicas_Credito " ConnectionString="<%$ ConnectionStrings:Taller %>">
                </asp:SqlDataSource>
                </asp:Panel>
            </asp:Panel>
