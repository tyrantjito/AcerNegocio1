<%@ Page Title="" Language="C#" MasterPageFile="~/AdmOrdenes.master" AutoEventWireup="true" CodeFile="PLDrIngresos.aspx.cs" Inherits="PLDrIngresos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <telerik:RadFormDecorator ID="RadFormDecorator1" RenderMode="Lightweight" runat="server" DecoratedControls="Buttons" />
     ...
     <%-- Nuevo Rango de Ingreso --%>
    <telerik:RadWindow RenderMode="Lightweight" ID="modalNuevo" Title="Nuevo Rango de Ingreso" EnableShadow="true" Skin="Metro"
            ...
            <asp:UpdatePanel ID="UpdatePanelEmi" runat="server">
                <ContentTemplate>
                     <asp:Panel ID="Panel2" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left"><asp:Label Visible="false" ID="Label5" runat="server" Text="Código Ingreso:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtCodRangoIngresoAdd" runat="server" Visible="false" CssClass="input-xxlarge" MaxLength="128" /></div>
                        ...
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtIdEscalaAdd" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
                         ...
                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label8" runat="server" Text="Rango Inicial de Ingreso:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtRInicialAdd" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>

                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label9" runat="server" Text="Rango Final de Ingreso:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtRFinalAdd" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>

                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label11" runat="server" Text="Tipo:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtTipoAdd" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
     ...
     <%-- Modifica Rango de Ingreso --%>
    <telerik:RadWindow RenderMode="Lightweight" ID="modalModifica" Title="Edita Rango de Ingreso" EnableShadow="true" Skin="Metro"
            ...
            <asp:UpdatePanel ID="UpdatePanelEmiMod" runat="server">
                <ContentTemplate>
                     <asp:Panel ID="Panel1" runat="server" CssClass="ancho100 text-center">
                        ...
                        <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label2" runat="server" Text="Código de Ingreso:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtCodRangoIngresoEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>

                          <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label17" runat="server" Text="Escala:" CssClass="textoBold"></asp:Label></div>
                        <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtEscalaIngresoEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>

                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label3" runat="server" Text="Rango Inicial de Ingreso: " CssClass="textoBold"></asp:Label></div>
                         <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtRangoInicialEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>

                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label6" runat="server" Text="Rango Final de Ingreso: " CssClass="textoBold"></asp:Label></div>
                         <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtRangoFinalEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>

                         <div class="col-lg-3 col-sm-3 text-left"><asp:Label ID="Label7" runat="server" Text="Tipo: " CssClass="textoBold"></asp:Label></div>
                         <div class="col-lg-9 col-sm-9 text-left"><asp:TextBox ID="txtTipoEdit" runat="server" CssClass="input-xxlarge" MaxLength="128" /></div>
     ...
     <div class="row">
        <div class="col-lg-12 col-sm-12 text-center alert-info">
            <h3>
                ...
                <asp:Label ID="Label10" runat="server" Text="Catálogo Rango de Ingreso"></asp:Label>
            </h3>
        </div>
    </div>
            ...
            <asp:Panel ID="pnlContenido" CssClass="col-lg-12 col-sm-12" runat="server" ScrollBars="Auto">
                <asp:Panel ID="pnlCatalogos" runat="server" CssClass="col-lg-12 col-sm-12" ScrollBars="Auto">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" AllowFilteringByColumn="true" OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged" runat="server" EnableHeaderContextMenu="true" Culture="es-Mx" Skin="Metro" 
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="false" DataKeyNames="codigo_ringreso">
                            <Columns>
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="codigo_ringreso" FilterControlAltText="Filtro codigo_ringreso" HeaderText="Código Rango de Ingreso" SortExpression="codigo_ringreso" UniqueName="codigo_ringreso" Resizable="true"  />
                                ...
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="inicial" FilterControlAltText="Filtro inicial" HeaderText="Rango Inicial de Ingreso" SortExpression="inicial" UniqueName="inicial" Resizable="true" />
                                <telerik:GridBoundColumn FilterCheckListEnableLoadOnDemand="true" DataField="final" FilterControlAltText="Filtro final" HeaderText="Rango Final de Ingreso" SortExpression="final" UniqueName="final" Resizable="true" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select *from PLD_Rango_Ingreso order by cast(codigo_ringreso as integer)" ConnectionString="<%$ ConnectionStrings:Taller %>">
                </asp:SqlDataSource>
                </asp:Panel>
            </asp:Panel>
